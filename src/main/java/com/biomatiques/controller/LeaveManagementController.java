...
public class LeaveManagementController {
    ...
    public String updateLeave(@PathVariable("id") long id, Model model ) {
		model.addAttribute("leaveManagement", leaveManagementService.getLeaveById(id));
		 return "editLeave";	
    }
    
    //Delete Method
	@RequestMapping(value="/deleteLeave/{id}",method=RequestMethod.GET,headers="Accept=application/json")
